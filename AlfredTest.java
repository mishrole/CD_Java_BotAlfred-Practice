public class AlfredTest {
    ...
    */
    public static void main(String[] args) {
        ...
        String testGuestGrettingSensei = alfredBot.guestGreeting();
        ...
        String angryTest = alfredBot.respondBeforeAlexis("¿Estás enojado?");
        ...
        System.out.println(testGuestGrettingSensei);
    }
}